...
function Game() {
	...
	function achchecker() {
		...
		const autoClickMilestones = {
			ac1: [1, 2, 12, 25, 50, 100, 150],
			ac2: [1, 2, 10, 25, 40, 100, 150],
			ac3: [1, 5, 10, 25, 50, 100, 150],
			ac4: [1, 5, 10, 25, 50, 100, 150],
			ac5: [1, 2, 10, 25, 41, 100, 150],
			ac6: [1, 5, 10, 25, 50, 100, 150],
			ac7: [1, 2, 10, 25, 50, 100, 150],
			ac8: [1, 5, 10, 25, 41, 100, 150],
			ac9: [1, 5, 10, 25, 50, 100, 150],
			ac10: [1, 5, 10, 25, 50, 100, 150],
			ac11: [1, 5, 10, 25, 50, 100, 150],
			ac12: [1, 3, 10, 25, 50, 100, 150],
			ac13: [1, 5, 10, 25, 50, 100, 150],
			ac14: [1, 5, 10, 25, 50, 90, 150],
